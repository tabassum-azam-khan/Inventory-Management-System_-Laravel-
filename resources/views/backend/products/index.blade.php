                    ...
                    <div class="col-auto">
                        <div class="page-utilities">
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                ...
                                <div class="col-auto">
                                    <a class="btn app-btn-primary" href="{{ route('products.create') }}"><svg
                                    ...
                                    <a class="btn app-btn-primary" href="{{ route('products.trash') }}"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <thead>
                                            <tr>
                                              <th class="cell">ID</th>
                                                ...
                                                <th class="cell">Opening Qty</th>
                                                <th class="cell">Qty Alert</th>
                                        ...
                                        <tbody>
                                            @foreach ($products as $product)
                                                <tr>
                                                    ...
                                                    <td class="cell">{{ $product->subcategory->name}}</td>
                                                    <td class="cell">{{ $product->unit->unit_short}}</td>
                                                    <td class="cell">{{ $product->opening_quantity }}</td>
                                                    <td class="cell">{{ $product->qty_alert }}</td>
                                                    <td class="cell">
                                                    ...
                                                    <td class="cell">{{ $product->remarks }}</td>
