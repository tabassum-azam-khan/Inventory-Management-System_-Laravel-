                    ...
                    <div class="col-auto">
                        <div class="page-utilities">
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                ...
                                <div class="col-auto">
                                    <a class="btn app-btn-primary" href="{{ route('customers.create') }}"><svg
                                         ...
                                         <a class="btn app-btn-primary" href="{{ route('customers.trash') }}"><svg
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="cell text-nowrap">
                                                        <a class="btn app-btn-primary"
                                                            href="{{ route('customers.show', $customer->id) }}"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="16"
                                                        ...
                                                        <a class="btn app-btn-primary2"
                                                            href="{{ route('customers.edit',$customer->id)}}"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="16"
