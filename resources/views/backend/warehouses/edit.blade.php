        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <div class="row g-3 mb-4 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">Edit Warehouse</h1>
                    </div>
                    <div class="col-auto">
                            ...
                            <div class="app-card-body">
                                ...
                                <form action="{{ route('warehouses.update', $warehouse->id) }}" method="POST" class="p-4">
                                    ...
                                    <div class="mb-3 px-4">
                                        ...
                                        <input type="text" value="{{ old('name', $warehouse->name) }}"
                                            class="form-control" id="name" name="name" placeholder="Enter Name">
                                    </div>

                                    <div class="mb-3 px-4">
                                        <label for="address" class="form-label" required>Address</label>
                                        <input type="text" value="{{ old('address', $warehouse->address) }}" class="form-control" id="address" name="address"
                                    ...
                                    <div class="mb-4 px-4">
                                        ...
                                        <textarea class="form-control" name="remarks" id="remarks" cols="30" rows="5" placeholder="Add Remarks">{{ old('remarks', $warehouse->remarks) }}</textarea>

                                    </div>

                                    <div class="mb-3 px-4">
                                        <button type="submit" class="btn app-btn-primary">Update</button>
                                        <a href="{{ route('warehouses.index') }}" class="btn app-btn-secondary">Cancel</a>
                                    </div>
                                </form>
