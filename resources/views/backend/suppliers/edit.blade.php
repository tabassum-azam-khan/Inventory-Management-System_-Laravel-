        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <div class="row g-3 mb-4 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">Edit Supplier</h1>
                    </div>
                    <div class="col-auto">
                            ...
                            <div class="app-card-body">
                                ...
                                <form action="{{ route('suppliers.update', $supplier->id) }}" method="POST" class="p-4">
                                    ...
                                    <div class="mb-3 px-4">
                                        ...
                                        <input type="text" value="{{ old('name', $supplier->name) }}"
                                            class="form-control" id="name" name="name" placeholder="Enter name">
                                    </div>

                                    <div class="mb-3 px-4">
                                        <label for="email" class="form-label">Email</label>
                                        <input type="email" value="{{ old('email', $supplier->email) }}"
                                    ...
                                    <div class="mb-3 px-4">
                                        ...
                                        <input type="text" value="{{ old('phone', $supplier->phone) }}"
                                            class="form-control" id="phone" name="phone" placeholder="Enter phone">
                                    </div>

                                    <div class="mb-3 px-4">
                                        <label for="address" class="form-label" required>Address</label>
                                        <input type="text" value="{{ old('phone', $supplier->address) }}"
                                    ...
                                    <div class="mb-3 px-4">
                                        ...
                                        <a href="{{ route('suppliers.index') }}" class="btn app-btn-secondary">Cancel</a>
                                    </div>
                                </form>
