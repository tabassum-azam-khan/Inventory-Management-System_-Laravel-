        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <div class="row g-3 mb-4 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">Categories Trash</h1>
                    </div>
                </div>
                <!--//row-->
                                    ...
                                    <table class="table app-table-hover text-left m-3">
                                        ...
                                        <tbody>
                                            @if ($categories->isEmpty())
                                                <tr>
                                                    <td colspan="8" class="text-center text-secondary">No Category Found.</td>
                                                </tr>
                                            @else
                                                @foreach ( $categories as $category )
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="cell">{{ $category->created_by }}</td>
                                                        <td class="cell">{{ $category->updated_by }}</td>
