                            ...
                            <div class="app-card-body">
                                ...
                                <form action="{{ route('categories.update', $category->id) }}" method="POST" class="p-4">
                                    ...
                                    <div class="mb-4 px-4">
                                        ...
                                        <textarea class="form-control" name="remarks" id="remarks" cols="30" rows="5" placeholder="Add Remarks">{{ old('remarks', $category->remarks) }}</textarea>

                                    </div>

                                    <div class="mb-3 px-4">
                                        <button type="submit" class="btn app-btn-primary">Update</button>
                                        <a href="{{ route('categories.index') }}" class="btn app-btn-secondary">Cancel</a>
                                    </div>
                                </form>
