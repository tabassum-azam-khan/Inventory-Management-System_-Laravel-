                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="cell text-nowrap">
                                                    <a class="btn app-btn-primary2" href="{{route('users.edit',$user->id)}}" tooltip="Edit"><svg
                                                   ...
                                                   <form action="{{ route('only_trashed',$user->id) }}"
                                                            method="POST" style="display:inline-block;"
                                                            onsubmit="return confirm('Are you sure?');">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class="btn app-btn-danger" tooltip="Move to Trash"><svg
