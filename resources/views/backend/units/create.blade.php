        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <div class="row g-3 mb-4 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">Create New Unit</h1>
                    </div>
                    <div class="col-auto">
                        ...
                        <div class="app-card shadow-sm mb-5">
                            <div class="app-card-body">
                                ...
                                <form action="{{ route('units.store') }}" method="POST" class="p-4">
                                    ...
                                    <div class="mb-3 px-4">
                                        ...
                                        <input type="text" class="form-control"
                                            id="name" name="name" placeholder="Enter Name">
                                                                            ...
                                                                            <div class="mb-3 px-4">
                                        <label for="short" class="form-label" required>Unit Short</label>
                                        <input type="text" class="form-control"
                                            id="short" name="short" placeholder="Enter Short">
                                                                           </div>
                                    ...
                                    <div class="mb-3 px-4">
                                        <button type="submit" class="btn app-btn-primary">Create Unit</button>
                                    </div>
                                </form>
