        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <div class="row g-3 mb-4 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">Companies Trash</h1>
                    </div>
                </div>
                <!--//row-->
                                    ...
                                    <table class="table app-table-hover text-left m-3">
                                        ...
                                        <tbody>
                                            @if ($companies->isEmpty())
                                                <tr>
                                                    <td colspan="8" class="text-center text-secondary">No Company Found.</td>
                                                </tr>
                                            @else
                                                @foreach ( $companies as $company )
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="cell">{{ $company->address }}</td>
                                                        ...
                                                        <td class="cell">{{ $company->remarks }}</td>
