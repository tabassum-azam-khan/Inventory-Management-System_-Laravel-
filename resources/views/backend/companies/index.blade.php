                    ...
                    <div class="col-auto">
                        <div class="page-utilities">
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                ...
                                <div class="col-auto">
                                    <a class="btn app-btn-primary" href="{{ route('companies.create') }}"><svg
                                         ...
                                         <a class="btn app-btn-primary" href="{{ route('companies.trash') }}"><svg
                                                ...
                                                <td class="cell">{{ $company->id }}</td>
                                                    ...
                                                    <td class="cell">
                                                        <a class="btn app-btn-primary"
                                                            href="{{ route('companies.show', $company->id) }}" title="View"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="16"
                                                        ...
                                                        <a class="btn app-btn-primary2"
                                                            href="{{ route('companies.edit',$company->id)}}" title="Edit"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="16"
