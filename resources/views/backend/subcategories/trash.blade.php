        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <div class="row g-3 mb-4 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">Sub-Categories Trash</h1>
                    </div>
                </div>
                <!--//row-->
                                    ...
                                    <table class="table app-table-hover text-left m-3">
                                        ...
                                        <tbody>
                                            @if ($subcategories->isEmpty())
                                                <tr>
                                                    <td colspan="8" class="text-center text-secondary">No Sub-Category Found.</td>
                                                </tr>
                                            @else
                                                @foreach ( $subcategories as $subcategory )
                                                    ...
                                                    <td class="cell">{{ $subcategory->category->name}}</td>
                                                    <td class="cell">
                                                    ...
                                                    <td class="cell">{{ $subcategory->remarks }}</td>


                                                        <td class="cell text-nowrap">
                                                            <div class="d-flex">
                                                                <form
                                                                    action="{{ route('subcategories.restore', $subcategory->id) }}"
                                                                ...
                                                                <form
                                                                    action="{{ route('subcategories.forceDelete', $subcategory->id) }}"
